...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5.overflow-hidden
    ...
    p.mb-0(data-aos="zoom-in-right") Por ejemplo, tiendas como Zara utilizan estrategias de merchandising visual mediante vitrinas atractivas, iluminación estratégica y organización de prendas para captar la atención del cliente.
      ...
      .row.justify-content-center.align-items-center.mb-0
        ...
        .col-12.col-lg-7.mb-3.mb-lg-0
          SlyderA(tipo="b").tarjeta.tarjeta--blanca.p-3.p-md-4.p-lg-2.p-xl-5.mb-0(data-aos="zoom-in-right")
            ...
            .row.justify-content-center.align-items-center
              .col-12.col-lg-10.mb-0
                h5.mb-4 Organización del layout comercial
    ...
    #t_3_5.titulo-segundo.color-acento-contenido
      .h2(data-aos="fade-right") 3.5 Visual merchandising
    .mb-0 
